...
export default function Home() {
  ...
  return (
    <div className="relative flex h-full w-full flex-col px-4 py-12 md:px-6 md:py-20">
      <section className="max-w-2xl mx-auto">
        {/* Background glow */}
        {/* <div
          className="pointer-events-none absolute inset-x-0 top-0 w-full h-full bg-linear-to-b from-primary/8 via-primary/3 to-transparent dark:from-primary/15 dark:via-primary/5"
          aria-hidden
        /> */}
        ...
        {/* Create Tournament */}
        <Card
          className="animate-slide-up relative mb-8 overflow-hidden border-primary/10 shadow-xl shadow-primary/6 ring-1 ring-black/4 dark:border-primary/15 dark:ring-white/4 dark:shadow-primary/8 pt-0"
          style={{ animationDelay: "80ms" }}
        >
          <div className="absolute inset-x-0 top-0 h-px bg-linear-to-r from-transparent via-primary/40 to-transparent" />
          <CardHeader className="border-b border-border/60 bg-muted/30 dark:bg-muted/10 pt-4">
                ...
                {saved
                  ...
                  .map((t) => (
                    <li key={t.publicId}>
                      <Link
                        href={`/t/${t.publicId}`}
                        onClick={() => setLoadingId(t.publicId)}
